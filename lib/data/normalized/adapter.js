...
import skinQualityBiostimulationTranslations from "./translations/skin-quality-biostimulation.json";
...
import skinQualityBiostimulationServices from "./services/skin-quality-biostimulation.json";
import skinQualityBiostimulationOptions from "./options/skin-quality-biostimulation.json";
import skinQualityBiostimulationPromos from "./promos/skin-quality-biostimulation.json";
import skinQualityBiostimulationAddons from "./addons/skin-quality-biostimulation.json";
import skinQualityBiostimulationFaqs from "./faqs/skin-quality-biostimulation.json";
import skinQualityBiostimulationExpectations from "./expectations/skin-quality-biostimulation.json";
...
const translations = [
  ...
  ...skinQualityBiostimulationTranslations,
...
const buildBeforeAfterGallery = (service = {}) => {
  ...
  return items
    .map((item) => {
      ...
      const captionSegments = Array.isArray(item.captionSegments)
        ? item.captionSegments
            .map((segment) => {
              const text = normalizeLocalizedValue(segment?.text);
              if (!text.en && !text.es) return null;
              return {
                text,
                ...(typeof segment?.href === "string" && segment.href ? { href: segment.href } : {}),
              };
            })
            .filter(Boolean)
        : [];
...
const datasets = [
  ...
  {
    services: skinQualityBiostimulationServices,
    options: skinQualityBiostimulationOptions,
    promos: skinQualityBiostimulationPromos,
    addons: skinQualityBiostimulationAddons,
    faqs: skinQualityBiostimulationFaqs,
    expectations: skinQualityBiostimulationExpectations,
  },
  {
