export const botox = {
  ...
  details: {
    en: "Neuromodulator injections temporarily relax facial muscles to smooth fine lines and dynamic wrinkles, enhancing skin texture and creating a more youthful, natural-looking appearance.",
    es: "Las inyecciones de neuromoduladores relajan temporalmente los músculos faciales para suavizar líneas finas y arrugas dinámicas, mejorando la textura de la piel y creando una apariencia más juvenil y natural."
  },
  notes: [
    {
    ...
    {
      en: "Touch-ups at this rate are only applicable within 1-2 weeks after initial application at the ",
