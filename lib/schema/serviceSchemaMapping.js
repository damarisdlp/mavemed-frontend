...
export const SERVICE_SCHEMA_CATEGORY_MAP = {
  neuromodulators: {
    key: "neuromodulators",
    name: "Neuromodulators (Botox and Generic Botulinum Toxin Type A)",
    description:
      "Medical neuromodulator treatments for dynamic wrinkles and prevention planning using premium and certified generic options.",
    lowPrice: 5.5,
    highPrice: 320,
    priceCurrency: "USD",
