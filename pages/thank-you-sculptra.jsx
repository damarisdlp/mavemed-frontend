...
export default function ThankYouSculptra() {
  ...
  const description = t("sculptra.subtitle");
  const canonical = `https://www.mavemedspa.com${locale === "es" ? "/es" : ""}/thank-you-sculptra`;
  const bodyLines = [t("sculptra.bodyLine1"), t("sculptra.bodyLine2")];
    ...
    <>
      ...
      <main className="bg-white pt-36 md:pt-40">
        <section className="max-w-3xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-base text-gray-700 mt-3">{t("sculptra.subtitle")}</p>
