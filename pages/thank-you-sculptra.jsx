...
const content = {
  en: {
    title: "Thank You",
    subtitle: "Your Sculptra candidacy assessment has been received.",
    body: [
      "Our team will review your information and contact you.",
      "If Sculptra isn’t the best option, we’ll guide you to safer alternatives.",
    ],
    cta: "Continue on WhatsApp",
  },
  es: {
    title: "Gracias",
    subtitle: "Hemos recibido tu evaluación de candidatura para Sculptra.",
    body: [
      "Nuestro equipo revisará tu información y te contactará pronto.",
      "Si Sculptra no es la mejor opción, te orientaremos con alternativas seguras.",
    ],
    cta: "Continuar en WhatsApp",
  },
};

export default function ThankYouSculptra() {
  ...
  const canonical = `https://www.mavemedspa.com${locale === "es" ? "/es" : ""}/thank-you-sculptra`;
