...
const content = {
  en: {
    title: "Sculptra Candidacy Assessment",
    deviceLine: "",
    subtitle: "Reviewed by a medical team before treatment planning.",
    support:
      "This short assessment helps determine whether Sculptra is appropriate for your goals before scheduling treatment.",
    supportDevice: "",
    ...
    medicalCopy:
      "Sculptra is a biostimulator and should be tailored to your anatomy, goals, and treatment history.",
    medicalBullets: [
  ...
  es: {
    title: "Evaluación de Candidatura para Sculptra",
    deviceLine: "",
    subtitle: "Revisado por un equipo médico antes de planear tratamiento.",
    support:
      "Esta evaluación breve ayuda a determinar si Sculptra es adecuado para tus objetivos antes de agendar cualquier tratamiento.",
    supportDevice: "",
    ...
    medicalCopy:
      "Sculptra es un bioestimulador y debe personalizarse según tu anatomía, objetivos e historial.",
    medicalBullets: [
...
export default function SculptraCandidacy() {
  return (
    <TreatmentCandidacyForm
      content={content}
      ogImagePath="/sylfirmx.jpg"
      funnelType="sculptra-candidacy"
      defaultTreatmentInterest="Sculptra"
      sourceLabelEn="Sculptra Funnel (EN)"
      sourceLabelEs="Sculptra Funnel (ES)"
      thankYouPathEn="/thank-you-sculptra"
      thankYouPathEs="/es/thank-you-sculptra"
