...
const content = {
  en: {
    title: "PLLA + RF Package Candidacy Assessment",
    deviceLine: "Using Sylfirm X",
    subtitle: "Reviewed by a medical team before treatment planning.",
    support:
      "This short assessment helps determine whether the PLLA + RF package is appropriate for your goals before scheduling treatment.",
    supportDevice:
  ...
  es: {
    title: "Evaluación de Candidatura PLLA + RF",
    deviceLine: "Con Sylfirm X",
    subtitle: "Revisado por un equipo médico antes de planear tratamiento.",
    support:
      "Esta evaluación breve ayuda a determinar si el paquete PLLA + RF es adecuado para tus objetivos antes de agendar cualquier tratamiento.",
    supportDevice:
...
export default function PLLARfCandidacy() {
  return (
    <TreatmentCandidacyForm
      content={content}
      ogImagePath="/sylfirmx.jpg"
      funnelType="sculptra-rf-candidacy"
      defaultTreatmentInterest="PLLA + RF Microneedling Package"
      sourceLabelEn="PLLA + RF Package Funnel (EN)"
      sourceLabelEs="PLLA + RF Package Funnel (ES)"
      thankYouPathEn="/thank-you-plla-rf"
      thankYouPathEs="/es/thank-you-plla-rf"
