...
const content = {
  en: {
    title: "PLLA Collagen Biostimulator",
    subtitle:
    ...
    treatmentLinkLabel: "View the PLLA treatment page",
    planInquiryPrefill:
      "Hi Mave, I’m interested in a collagen rebuilding treatment plan with PLLA. Can you share options and pricing?",
    ...
    sections: [
      ...
      {
        title: "How PLLA works, collagen signaling over time",
        body: [
      ...
      {
        title: "PLLA results timeline, what to expect",
        body: [
      ...
      {
        title: "What concerns can PLLA help improve",
        body: [
      ...
      {
        title: "How PLLA differs from hyaluronic acid fillers",
        body: [
      ...
      {
        title: "Why PLLA does not last forever",
        body: [
  ...
  es: {
    title: "PLLA Bioestimulador de Colágeno",
    subtitle:
      "Un enfoque médico para regeneración gradual de colágeno, soporte estructural y resultados a largo plazo",
    intro: [
      "PLLA a veces se describe como relleno, pero su comportamiento es diferente a los rellenos tradicionales de ácido hialurónico.",
      "En lugar de aportar volumen inmediato con gel, PLLA está diseñado para estimular la producción de colágeno con el tiempo, con resultados que se construyen de forma gradual.",
    ...
    planCardCopy:
      "Si quieres un plan estructurado y por etapas, podemos mapear un enfoque conservador usando PLLA, RF microneedling y otras modalidades cuando sea apropiado.",
    planCardCta: "Escríbenos sobre un plan de colágeno",
    treatmentLinkLabel: "Ver la página del tratamiento PLLA",
    planInquiryPrefill:
      "Hola Mave, me interesa un plan de reconstrucción de colágeno con PLLA. Me pueden compartir opciones y precios?",
    videosTitle: "Video explicativo",
    videosIntro:
      "Este video sobre el mecanismo de PLLA ayuda a entender la biología del cambio gradual del colágeno.",
    videoItems: [
      {
        id: "XETrgeV1x2c",
        title: "Resumen del mecanismo de PLLA",
        summary: [
          ...
          "Describe PLLA como bioestimulador de PLLA que induce una respuesta controlada de fibroblastos y neocolagénesis gradual en la dermis.",
    ...
    sections: [
      {
        title: "Qué es PLLA",
        body: [
          "PLLA es un inyectable bioestimulador de colágeno compuesto por ácido poli L láctico, PLLA.",
      ...
      },
      {
        ...
        body: [
          "Después de la aplicación, las partículas de PLLA actúan como estímulo para que el cuerpo produzca nuevo colágeno.",
      ...
      {
        title: "Línea de tiempo de resultados con PLLA",
        body: [
          "PLLA se malinterpreta porque los primeros días a veces se ven “mejor”, y luego se asienta.",
          "**Eso es normal. PLLA es un proceso de colágeno, no un resultado inmediato.**",
      ...
      {
        title: "Qué puede ayudar a mejorar PLLA",
        body: [
          "Cuando está clínicamente indicado, PLLA puede apoyar:",
          ...
          "**PLLA no está diseñado para rellenar líneas superficiales en zonas de piel muy delgada.**",
        ],
        bullets: [
      ...
      },
      {
        ...
        body: [
          ...
          "PLLA estimula colágeno con el tiempo.",
        ...
        bullets: [
          ...
          "PLLA, señalización y reconstrucción gradual",
          "Con PLLA es común planear en serie",
      ...
      },
      {
        ...
        body: [
          "**PLLA normalmente se planea en serie porque el colágeno se construye poco a poco.**",
      ...
      {
        title: "Por qué PLLA no dura para siempre",
        body: [
          "PLLA ayuda a construir colágeno, pero no detiene el envejecimiento.",
          ...
          "**El mantenimiento no es porque PLLA falló, es porque el envejecimiento continúa.**",
        ],
        bullets: [
      ...
      },
      {
        ...
        body: [
          "**PLLA es altamente dependiente de la técnica.**",
      ...
      },
      {
        ...
        body: [
          "PLLA puede no ser adecuado para personas embarazadas o lactando, con infección o inflamación activa en el área, o que buscan un cambio dramático inmediato en una sola sesión.",
      ...
      },
      {
        ...
        body: [
          "**PLLA está diseñado para quienes valoran un cambio gradual y natural.**",
...
const slug = "/learn/plla-collagen-biostimulator";
...
const PLLA_TREATMENT_SLUG = "/treatments/collagen-biostimulator-plla";
...
export default function PLLAEducationPage() {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        name: "PLLA Collagen Biostimulator",
        alternateName: [
          "PLLA collagen biostimulator",
          "PLLA facial collagen stimulation",
          "PLLA for volume loss education",
        ],
        description:
          "PLLA is an injectable collagen biostimulator containing poly L lactic acid, PLLA. It is used in aesthetic medicine to support gradual collagen production and improve structural support, contour balance, and selected skin quality concerns when clinically appropriate.",
        ...
        <section className="max-w-5xl mx-auto px-6 py-12">
          <div className="text-left max-w-3xl">
            ...
            <LearnCategoryBreadcrumb
              locale={locale}
              categoryLabel={locale === "es" ? "Bioestimulación de colágeno" : "Collagen Biostimulation"}
              categoryAnchor="collagen-biostimulation"
            />
          ...
          <div className="mt-8 max-w-3xl space-y-4">
            ...
            <div className="border border-gray-200 bg-[#f9f9f9] rounded-2xl p-5 space-y-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <a
                  href={`/${locale === "es" ? "es/" : ""}${PLLA_TREATMENT_SLUG.replace(
                    /^\//,
                    ""
                  )}`}
                  className="inline-flex text-sm text-[#731a2f] underline underline-offset-4"
